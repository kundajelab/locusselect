...
CUDA_VISIBLE_DEVICES=1 compute_embeddings \
		    ...
		    --center_on_summit \
		    --flank 125 \
		    --output_npz_file k562_dnase_classification_embeddings.0.1.flank125.1.pool10.npz \
		    --embedding_layer 1 \
		    --expand_dims \
		    --threads 40 \
		    --non_global_pool_on_position_size 50 \
		    --non_global_pool_on_position_stride 50 
